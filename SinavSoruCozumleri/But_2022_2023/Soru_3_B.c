...
{
	a = b; 		// b' nin adresi a ya atanmistir. a ve b degiskenleri ayni degerleri alacaktir anlamına gelmektedir. Aynı adresi paylaştıklarından dolayı
	*b = 17; 	// b degeri 17 degeri almistir
	*a = *a + 1;    // A nin degeri bir artirilmistir. // Bu durumda 18 olacaktir.
}
...
int main()
{
	...
	*y = 0;
	...
	printf("x = %d, y = %d\n", *x, *y); // x = 17 y = 18 degerini alır.
	
	/*
	 * Şu husus onem arz etmektedir. Girilen degerler eğer bir işaretçi ise bellek üzerinden işlem yapıldığı için fonksiyonlarda da degeri degismektedir.
